...
- find_valid_group_chip_IDs() in helpers: 
...
- create_working_directory() in helpers:
...
- export_list_all_image_files() in helpers: 
...
- create_result_filepath() in helpers:
...
- select_valid_image_files() in helpers:
