...
- relativ auf alle Pixel normierung
- export png/tiff mit data.sum
- export tissue area results
- rubustness? verschiedene positions, chipgruppe
- verschiedene gewebe

- vgl mit spencer werte
- evtl hot pixel alg
