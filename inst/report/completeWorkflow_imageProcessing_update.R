...
output_dir_image_processing <- file.path(output_dir,"image_processing")
input_dir_dataSum <- file.path(output_dir_image_processing, "data_sum_collection_3")
...
#                   paste0("dataSum_",chip_ID,"_",pos_ID,".rds")))
 ...
 pos_ID <- image_groups$pos_ID[j]
m_data_sum <- readRDS(
                      file.path(output_dir_image_processing,
                                "data_sum_collection_3",
                                paste0("dataSum_",chip_ID,"_",pos_ID,".rds")))
