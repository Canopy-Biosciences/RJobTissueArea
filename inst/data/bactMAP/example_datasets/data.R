...
#'  \item{Xrot_micron}{the x-coordinate of the cell outline point (in micron) when the cell length axis is horizontal, with mid-cell at (0,0)}
#'  \item{Yrot_micron}{the y-coordinate of the cell outline point (in micron) when the cell lenth axis is horizontal, with mid-cell at (0,0)}
#' }
#' @examples
#' \dontrun{
#'  DnaX_mesh
...
#' @format A data frame with columns:
#' \describe{
#'  \item{x}{x-coordinate of detected FtsZ filament}
#'  \item{y}{y-coordinate of detected FTsZ filament}
#'  \item{frame}{frame identifier. in this case, an image was taken every 20 seconds, so 1 frame corresponds to 20s.}
#'  \item{cell}{cell identifier. unique per frame.}
...
#'  \item{fluorsum}{the sum of the total fluorescence inside the cell. inherited from SuperSegger (see \href{https://github.com/wiggins-lab/SuperSegger/wiki}{the SuperSegger Wiki} for more information)}
#'  \item{fluormean}{the mean of the total fluorescence inside the cell. inherited from SuperSegger (see \href{https://github.com/wiggins-lab/SuperSegger/wiki}{the SuperSegger Wiki} for more information)}
#'  \item{fluorsum_D}{the sum of the fluorescence at cell division. inherited from SuperSegger (see \href{https://github.com/wiggins-lab/SuperSegger/wiki}{the SuperSegger Wiki} for more information)}
#'  \item{fluormean_D}{the mean of the total fluorescence at cell division. inherited from SuperSegger (see \href{https://github.com/wiggins-lab/SuperSegger/wiki}{the SuperSegger Wiki} for more information)}
